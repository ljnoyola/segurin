/*El calculo de la letra del documento nacional de identiad del DNI es un prodeso
matemático sencillo que se basa en obtener el resto de la división entera del número
de DNI y el número 23. A partir del resto de la división, se obtiene la letra seleccionándo
...
Si no coinciden, se muestra un mensaje al usuario diciéndole que la letra que ha indicado no es correcta. 
...
var letra=prompt("Introduce la letra de ty DNI(en mayusculas)");
var resto = dni%23;
